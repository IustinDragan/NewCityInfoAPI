        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "The one with the cathedral that is never really finished.", "Antwerp" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 2, "A Gothic style cathedral, conceived by architects...", "Cathedral" },
                    { 5, 3, "A wrought iron lattiece tower on the Champ de Mars, named...", "Eiffel Tower" },
